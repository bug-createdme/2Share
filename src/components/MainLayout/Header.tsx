        ...
        <nav className="bg-[#f3b4c3] rounded-[20px] sm:rounded-[35px] px-4 sm:px-8 py-4 sm:py-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {isLoading ? null : user ? (
              ...
              <>
                <button
                  className="bg-[#f2e4e4] text-black font-bold text-sm sm:text-xl font-spartan px-2 sm:px-4 py-1 sm:py-2 rounded-[8px] sm:rounded-[10px] hover:bg-gray-300 transition-colors"
                  onClick={() => navigate('/login')}
                >
                  Đăng nhập
                </button>
                <button
                  className="bg-[#161515] text-[#FCF1F1] font-bold text-sm sm:text-xl font-spartan px-3 sm:px-6 py-1 sm:py-2 rounded-[20px] sm:rounded-[30px] hover:bg-gray-800 transition-colors"

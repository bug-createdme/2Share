      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            ...
            <div className="absolute top-4 left-4 flex items-center justify-center w-10 h-10">
              <img 
            ...
            <div className="absolute bottom-4 right-4 w-10 h-10 bg-white/10 rounded-lg border border-white flex items-center justify-center">

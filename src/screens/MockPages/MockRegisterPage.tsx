// src/screens/MockPages/MockRegisterPage.tsx
...
const MockRegisterPage: React.FC = () => {
  ...
  // XỬ LÝ ĐĂNG KÝ MOCK - KHÔNG VALIDATION
  const handleMockRegister = async (e: React.FormEvent) => {
    e.preventDefault();
    
    // Không validate, chỉ kiểm tra trường bắt buộc cơ bản
    ...
    // Mock API call - chỉ delay 1.5 giây rồi chuyển hướng
    try {
      await new Promise(resolve => setTimeout(resolve, 1500));
      
      // Chuyển đến Mock My Links
      navigate('/demo/my-links');
    ...
    <div className="h-screen bg-white flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-[679px] flex flex-col items-center px-4 sm:px-0 pt-[70px]">
        <div className="w-full flex flex-col items-center">
          ...
          {/* Register Form */}
          <form className="mb-[18px] w-full flex flex-col items-center space-y-3" onSubmit={handleMockRegister}>
            {/* Họ và tên */}
            ...
            {/* Mật khẩu - VẪN MÃ HÓA NHƯ THƯỜNG */}
            <div className="w-[475px] min-h-[59px] bg-[#F0F0F0] rounded-[10px] px-[21px] flex flex-col justify-center">
            ...
            {/* Xác nhận mật khẩu - VẪN MÃ HÓA NHƯ THƯỜNG */}
            <div className="w-[475px] min-h-[59px] bg-[#F0F0F0] rounded-[10px] px-[21px] flex flex-col justify-center">
              <div className="flex items-center">
                <input
